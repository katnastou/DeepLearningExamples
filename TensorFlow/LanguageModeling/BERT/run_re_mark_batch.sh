...
###MODELS="/scratch/project_2001426/models/biobert_v1.1_pubmed"
...
max_seq_len="96"
init_ckpt="/scratch/project_2001426/models/biobert_large/bert_model.ckpt"
...
for learning_rate in $LEARNING_RATE; do
    for epochs in $EPOCHS; do
        for keep_prob in $KEEP_PROB; do
            ...
            touch output-biobert/relationextraction/large/$job_id
            sleep 2
        done
    done
done
