...
#cp ${OUTPUT_DIR}"/output_with_probabilities_dict.tsv" "/scratch/project_2001426/stringdata/week_31_2/species/org-predictions/output_with_probabilities_"$(basename ${DATASET_DIR##*-})".tsv"
...
#echo -n 'result written in /scratch/project_2001426/stringdata/week_35/lsf-predictions'$'\n'
echo -n 'result written in /scratch/project_2001426/stringdata/week_50/tokenization'$'\n'
seff $SLURM_JOBID
